...
/**
 * Genera docs/Diagnostico-WhatsApp-Anlux-Soporte.docx
 * Ejecutar: php scripts/generar-doc-diagnostico-whatsapp.php
 */

$outDir = 'C:\\Anlux_Documentacion';
$outFile = $outDir.'\\Diagnostico-WhatsApp-Anlux-Soporte.docx';
...
$sections = [
    ['title' => 'Diagnóstico WhatsApp Cloud API — Anlux', 'level' => 0],
    ['title' => 'Sitio: soporte.anlux.mx', 'level' => 0, 'text' => 'Documento generado a partir del análisis técnico realizado en mayo 2026. Resume preguntas, pruebas, cambios aplicados y causa raíz del fallo.'],
    ['title' => '1. Resumen ejecutivo', 'level' => 1, 'text' => "El sistema Anlux Laravel está configurado correctamente para enviar WhatsApp automático al guardar o cambiar órdenes en estatus Recepción, Terminado y Entregado.\n\nEl mensaje NO llega al cliente porque el hosting (cuenta joses16, servidor compartido cPanel/LiteSpeed) no logra establecer conexión HTTPS saliente hacia graph.facebook.com (API de Meta/WhatsApp).\n\nLa prueba definitiva es docheck.php?key=anlux99&wa_test_meta=1, que falla con:\ncURL error 28: Connection timed out after 10003 milliseconds\n\nEsto NO es un error de token, plantilla, PDF ni código Laravel: es un bloqueo o fallo de red del proveedor de hosting."],
    ...
    ['title' => '14. Conclusión final', 'level' => 1, 'text' => "El software Anlux cumple con el diseño: envío automático por estatus, teléfono de la orden, plantillas Meta, PDF adjunto vía enlace firmado, cola en background sin bloquear guardado.\n\nEl único impedimento restante es de INFRAESTRUCTURA: el hosting joses16/soporte.anlux.mx no establece conexión saliente con graph.facebook.com.\n\nAcción requerida: Ticket al proveedor de hosting. Sin resolución de red, WhatsApp no funcionará desde este servidor sin importar scripts, tokens o plantillas."],
];
