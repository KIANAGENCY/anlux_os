  ...
  return (
    <section className="rounded-r-lg border-l-4 border-blue-500 bg-blue-50 p-4 sm:pl-6">
      <h2 className="mb-6 flex items-center text-xl font-bold text-blue-900 sm:text-2xl">
        <i className="fas fa-boxes mr-3 text-blue-500" aria-hidden="true" />
                ...
                <tr key={idx} className="hover:bg-blue-100">
                  <td className="border p-2">
                    <input
                      ...
                      disabled={readOnly}
                      value={m.vale}
                      aria-label={`Vale de material ${idx + 1}`}
                      data-anlux-field={`material.${idx}.vale`}
                      onChange={(e) => update(idx, { vale: e.target.value.toUpperCase() })}
                      placeholder="Vale"
                    />
                  </td>
                  <td className="border p-2">
                    <input
                      ...
                      disabled={readOnly}
                      value={m.codigo}
                      aria-label={`Código o SKU de material ${idx + 1}`}
                  ...
                  <td className="border p-2">
                    <input
                      ...
                      disabled={readOnly}
                      value={m.cant}
                      aria-label={`Cantidad de material ${idx + 1}`}
                      data-anlux-field={`material.${idx}.cant`}
                      onChange={(e) => update(idx, { cant: e.target.value })}
                      placeholder="Cant."
                    />
                  </td>
                  <td className="border p-2">
                    <input
                      ...
                      disabled={readOnly}
                      value={m.descripcion}
                      aria-label={`Descripción de material ${idx + 1}`}
                  ...
                  <td className="border p-2">
                    <input
                      ...
                      disabled={readOnly}
                      value={m.ticket}
                      aria-label={`Ticket de material ${idx + 1}`}
                  ...
                  <td className="border p-2">
                    <select
                      ...
                      disabled={readOnly}
                      value={m.id_equipo}
                      aria-label={`Equipo asignado a material ${idx + 1}`}
                  ...
                  <td className="border p-2 text-center whitespace-nowrap">
                    ...
                    {!readOnly ? (
                      <button
                        ...
                        onClick={() => remove(idx)}
                        title={`Quitar material ${idx + 1}`}
                        aria-label={`Quitar material ${idx + 1}`}
                      >
