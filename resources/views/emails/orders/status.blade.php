@php
    ...
    $mensaje = match ($estatus) {
        ...
        'Entregado' => 'Su equipo fue entregado correctamente. Gracias por confiar en Exacto.',
...
<body style="margin:0; padding:0; background:#f2f6ff; font-family:Arial, Helvetica, sans-serif; color:#0f2544;">
    <div style="max-width:680px; margin:0 auto; padding:24px 12px;">
        <div style="background:#ffffff; border:1px solid #c7d7ff; border-radius:14px; overflow:hidden;">
            <div style="background:#0d47a1; color:#ffffff; padding:18px 22px;">
                @if($logoSrc !== null)
                ...
                @endif
                <h1 style="margin:0; font-size:22px;">Exacto - Orden de servicio</h1>
                @if($folio !== '')
            ...
            <div style="padding:22px;">
                ...
                <div style="border:1px solid #d6e2ff; border-radius:10px; padding:14px; margin-bottom:18px;">
                    <h2 style="margin:0 0 10px; font-size:16px; color:#0d47a1;">Datos del cliente</h2>
                ...
                <div style="border:1px solid #d6e2ff; border-radius:10px; padding:14px; margin-bottom:18px;">
                    <h2 style="margin:0 0 10px; font-size:16px; color:#0d47a1;">Datos del equipo</h2>
                ...
                <p style="margin:20px 0 0; line-height:1.5; font-size:14px; color:#36506f;">
                    Este correo es una notificación automática de Exacto. Si tiene alguna duda, puede comunicarse con nosotros proporcionando su folio de orden.
                </p>
            </div>
        </div>
    </div>
