...
final class RepeatTerminadoStatusTest extends TestCase
{
    ...
    public function test_confirming_terminado_again_replaces_date_and_forces_whatsapp(): void
    {
        Bus::fake();
        Http::fake([
            'https://graph.facebook.com/*' => Http::response([
                'messages' => [['id' => 'wamid.REPEAT-TERMINADO']],
            ]),
        ]);
        config([
        ...
        $this->assertDatabaseCount('order_whatsapp_notifications', 2);
        $this->assertDatabaseHas('order_whatsapp_notifications', [
            'id_orden_c' => 600,
            'estatus' => 'Terminado',
            'provider_message_id' => 'wamid.REPEAT-TERMINADO',
            'status' => 'accepted',
        ]);
    }
}
