...
@section('content')
    ...
    <p>
        ...
        responsable del sistema <strong>{{ $producto }}</strong>, pone a tu disposicion este procedimiento para solicitar la
    ...
    <ul>
        <li>
            ...
            <strong>{{ $privacyEmail }}</strong> con el asunto &laquo;Eliminacion de datos&raquo;.
        </li>
        <li>
