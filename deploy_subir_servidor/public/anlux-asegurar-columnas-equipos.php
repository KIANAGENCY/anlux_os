 ...
 * URL: https://TU-DOMINIO/anlux-asegurar-columnas-equipos.php?key=anlux2026diag
...
echo "=== Anlux: columnas entrega por equipo ===\n\n";
...
echo "\nBORRA public/anlux-asegurar-columnas-equipos.php cuando termines.\n";
echo '</pre>';
