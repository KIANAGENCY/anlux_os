 ...
 */
(function (global) {
    function exactoPdfPreferirNuevaPestana() {
     ...
     */
    function exactoAbrirPdf(id, folio, options) {
        const url = options.urlBuilder(id);

        if (exactoPdfPreferirNuevaPestana()) {
    ...
    global.exactoPdfView = {
        preferirNuevaPestana: exactoPdfPreferirNuevaPestana,
        abrir: exactoAbrirPdf,
    };
})(window);
