...
/**
 * Vacía tablas del dominio de órdenes (Anlux) y reinicia AUTO_INCREMENT vía TRUNCATE.
 */
class AnluxWipeOrdenesDataCommand extends Command
{
    protected $signature = 'anlux:wipe-ordenes-data
    ...
    protected $description = 'Vacía tablas de órdenes Anlux y reinicia contadores AUTO_INCREMENT (MySQL/MariaDB).';
