...
class ExactoSelfTestLoginCommand extends Command
{
    protected $signature = 'exacto:self-test-login
    ...
    public function handle(ExactoVaultService $vault, LoginIdSequenceService $loginIdSequence): int
    {
        ...
        $suffix = (string) time();
        $correo = 'exacto.selftest.'.$suffix.'@example.invalid';
        $nombre = 'Exacto SelfTest '.$suffix;
        $password = 'SelfTest1!';
