 ...
 */
class ExactoMigrarPreciosSinIvaCommand extends Command
{
    protected $signature = 'exacto:migrar-precios-sin-iva
    ...
    public function handle(): int
    {
        ...
        $marker = storage_path('app/exacto_precios_sin_iva.migrated');
        if (! $dry && is_file($marker)) {
            $this->error('Ya existe el marcador de migración (storage/app/exacto_precios_sin_iva.migrated). No se vuelve a ejecutar para evitar doble conversión.');
        ...
        if ($dry) {
            ...
            $this->line('Marcador: storage/app/exacto_precios_sin_iva.migrated');
