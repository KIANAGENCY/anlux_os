 ...
 */
class ExactoWipeDominioCommand extends Command
{
    protected $signature = 'exacto:wipe-dominio
                            {--force : Sin confirmación (obligatorio en production)}
                            {--admin=admin@soporte.exactolp.mx : Correo del admin a conservar}';
    ...
    public function handle(): int
    {
        ...
        if (app()->environment('production') && ! $this->option('force')) {
            $this->error('En producción use: php artisan exacto:wipe-dominio --force');
        ...
        try {
            ...
            if (Schema::hasTable('exacto_login_sequences')) {
                DB::table('exacto_login_sequences')->updateOrInsert(
