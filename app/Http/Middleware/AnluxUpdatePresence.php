...
final class AnluxUpdatePresence
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        try {
            ...
            Log::warning('AnluxUpdatePresence: '.$e->getMessage(), [
                'exception' => $e::class,
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ]);
    ...
    private function handlePresence(Request $request, Closure $next): Response
    {
        ...
        if ($user !== null && ! AnluxAuthContext::isImpersonating()) {
        ...
        } elseif ($user !== null && AnluxAuthContext::isImpersonating()) {
