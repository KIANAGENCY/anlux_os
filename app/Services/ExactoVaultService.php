 ...
 */
final class ExactoVaultService
{
    public function telefonoSecretBin(): ?string
    {
        $s = (string) config('exacto.telefono_secret', '');
    ...
    public function loginCelularPepperBin(): string
    {
        ...
        $root = rtrim(str_replace(['/', '\\'], DIRECTORY_SEPARATOR, (string) config('exacto.pepper_root')), DIRECTORY_SEPARATOR);
    ...
    /** Igual que exacto_tecnico_nombre_token() en legacy. */
